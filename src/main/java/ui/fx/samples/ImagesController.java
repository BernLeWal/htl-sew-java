...
public class ImagesController extends AbstractController {
    ...
    public void initialize() {
        defaultImage = new Image(ImagesController.class.getResourceAsStream("/ui/fx/placeholder.jpg"));
    ...
    public void onSetPictureClicked(ActionEvent actionEvent) {
        Image image = new Image(ImagesController.class.getResourceAsStream("/ui/fx/Roboter.jpg"));
    ...
    public void onOpenUrlClicked(ActionEvent actionEvent) {
        ...
        td.setHeaderText("""
                    Enter the URL of an image you want to download and display:
                    """);

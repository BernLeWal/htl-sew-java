...
* __Puzzle__ implements the field-moving puzzle game, where you have to bring the numbers 1-8 inside a 3x3 field
...
then build the war with the maven command: ```mvn war:war```  
